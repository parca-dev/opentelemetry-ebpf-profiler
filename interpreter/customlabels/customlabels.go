...
func (d data) Attach(ebpf interpreter.EbpfHandler, pid libpf.PID,
	...
	// TODO - get current HM offset. Also we need to actually write something like "doesn't have HM"
	// if that's indeed the case rather than just filling in 0 (because 0 might be valid!)
