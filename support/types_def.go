...
var MetricsTranslation = []metrics.MetricID{
	...
	C.metricID_UnwindPythonErrBadFrameObjectBackAddr:           metrics.IDUnwindPythonErrBadFrameObjectBackAddr,
	C.metricID_UnwindPythonErrBadFrameCodeObjectAddr:           metrics.IDUnwindPythonErrBadFrameCodeObjectAddr,
	C.metricID_UnwindPythonErrBadFrameLastInstructionAddr:      metrics.IDUnwindPythonErrBadFrameLastInstructionAddr,
	C.metricID_UnwindPythonErrBadCodeObjectKWOnlyArgCountAddr:  metrics.IDUnwindPythonErrBadCodeObjectKWOnlyArgCountAddr,
	C.metricID_UnwindPythonErrBadCodeObjectFlagsAddr:           metrics.IDUnwindPythonErrBadCodeObjectFlagsAddr,
	C.metricID_UnwindPythonErrBadCodeObjectFirstLineNumberAddr: metrics.IDUnwindPythonErrBadCodeObjectFirstLineNumberAddr,
