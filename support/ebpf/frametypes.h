...
// Synthetic frame attached by the user-space reporter to a memory-origin trace
// to carry the allocation payload (alloc/free counts and byte totals). Not
// produced by the eBPF unwinder.
#define FRAME_MARKER_MEMORY_PAYLOAD 0xF
